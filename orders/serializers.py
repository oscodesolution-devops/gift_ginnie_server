...
class CouponSerializer(serializers.ModelSerializer):
    class Meta:
        model = Coupon
        fields = ["id", "code", "title", "description", "discount_type", "discount_value", "max_usage", "max_usage_per_user", "valid_from", "valid_until", "is_active"]
...
class CartSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Cart
        fields = ["id", "user", "items", "coupon", "total_items", "original_price", "discounted_price", "discount_percentage"]
...
class OrderItemSerializer(serializers.ModelSerializer):
    ...
    def get_my_rating(self, obj):
        rating = ProductRating.objects.filter(
            user=self.context["request"].user, product=obj.product
        ).first()
        if rating:
...
class OrderSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Order
        fields = ["id", "status", "total_price", "discount_applied", "final_price", "created_at", "updated_at", "delivery_address", "items"]
        read_only_fields = ["id", "status", "total_price", "discount_applied", "final_price", "created_at", "updated_at", "delivery_address", "items"]
